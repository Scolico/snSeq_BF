...
gsva.score<-gsva(matrix,targetSets,min.sz=5,kcdf='Gaussian') ###ÓÃcounts kcdf='Poisson',else'Gaussian'
...
tt <- sapply(cell,function(b) rowMeans(gsva.score.1[,b])) ###°´·Ö×éÐÅÏ¢ÇóÆ½¾ùÖµ
